...
class NFRCamManager(Screen):
  ...
  <screen name="NFRCamManager" position="center,center" size="820,410" title="NFR SoftCam Manager">
    ...
    <ePixmap pixmap="skin_default/buttons/big-red-on.png" position="2,368" size="200,40" alphatest="blend" zPosition="-1" />
    <ePixmap pixmap="skin_default/buttons/big-green-on.png" position="208,368" size="200,40" alphatest="blend" zPosition="-1" />
    <ePixmap pixmap="skin_default/buttons/big-yellow-on.png" position="412,368" size="200,40" alphatest="blend" zPosition="-1" />
    <ePixmap pixmap="skin_default/buttons/big-blue-on.png" position="615,368" size="200,40" alphatest="blend" zPosition="-1" />
	...
	def createcamlist(self):
		...
		if self.actcam != "none":
			softpng = LoadPixmap(cached=True, path=resolveFilename(SCOPE_PLUGINS,
				"/usr/share/enigma2/skin_default/icons/actcam.png"))
			self.list.append((self.actcam, softpng, self.checkcam(self.actcam)))
		softpng = LoadPixmap(cached=True, path=resolveFilename(SCOPE_PLUGINS,
			"/usr/share/enigma2/skin_default/icons/defcam.png"))
		for line in self.softcamlist:
			if line != self.actcam:
...
<screen name="ConfigEdit" position="center,center" size="620,180" title="SoftCam path configuration">
  <ePixmap pixmap="skin_default/buttons/big-red-on.png" position="7,121" size="295,40" alphatest="blend" zPosition="-1" />
  <ePixmap pixmap="skin_default/buttons/big-green-on.png" position="313,122" size="295,40" alphatest="blend" zPosition="-1" />
