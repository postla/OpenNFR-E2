...
if (config.plugins.showinfopanelextensions.getValue() or config.plugins.infopanel_redpanel.enabledlong.getValue()):
...
#		global servicelist
		...
		self.Mlist.append(MenuEntryItem((InfoEntryComponent('Yellow-Key-Action'), _("Yellow Panel"), 'Yellow-Key-Action')))			
