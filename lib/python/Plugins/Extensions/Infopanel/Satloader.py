	...
	if framewidth == 1280:
		skin = """
			<screen position="240,130" size="800,510" title="Satloader Plugin" >
				<ePixmap position="8,4" size="190,32" pixmap="skin_default/buttons/button_red_sm.png" alphatest="on" />
				<ePixmap position="206,4" size="190,32" pixmap="skin_default/buttons/button_green_sm.png" alphatest="on" />
				<ePixmap position="404,4" size="190,32" pixmap="skin_default/buttons/button_yellow_sm.png" alphatest="on" />
				<ePixmap position="602,4" size="190,32" pixmap="skin_default/buttons/button_blue_sm.png" alphatest="on" />
				...
				<ePixmap position="730,457" size="50,35" zPosition="2" pixmap="skin_default/buttons/key_info.png" alphatest="on" />
			</screen>"""
	elif framewidth == 720:
		skin = """
...
class SatloaderAbout(Screen):
	skin = """
		<screen position="center,center" size="360,280" title="%s">
			<ePixmap position="120,40" size="100,40" pixmap="skin_default/buttons/satloader.png" alphatest="on" />
