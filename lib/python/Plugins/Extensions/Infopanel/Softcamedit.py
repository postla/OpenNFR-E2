	...
	if HDSkn:
		if (getDesktop(0).size().width()) > 1030:
			  ...
			  <screen name="vEditor" position="40,90" size="1180,590" title="File-Explorer">
                          ...
                          <ePixmap position="332,559" size="35,27" pixmap="skin_default/green.png" alphatest="blend" />
                          <ePixmap position="658,559" size="35,27" pixmap="skin_default/yellow.png" alphatest="blend" />
                          <ePixmap position="984,559" size="35,27" pixmap="skin_default/blue.png" alphatest="blend" />
