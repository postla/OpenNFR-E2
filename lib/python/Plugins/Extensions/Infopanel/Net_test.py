...
class Net_test(Screen):
  ...
  <ePixmap position="6,559" size="35,27" pixmap="skin_default/red.png" alphatest="blend" />
  <ePixmap position="252,559" size="35,27" pixmap="skin_default/green.png" alphatest="blend" zPosition="2" />
  <ePixmap position="493,559" size="35,27" pixmap="skin_default/yellow.png" alphatest="blend" zPosition="3" />
  <ePixmap position="724,559" size="35,27" pixmap="skin_default/blue.png" alphatest="blend" zPosition="4" />
  <ePixmap position="955,557" size="70,30" pixmap="skin_default/info.png" alphatest="blend" />
  ...
  <eLabel name="new eLabel" position="6,553" size="1170,2" backgroundColor="blue" foregroundColor="blue" />
			...
			<screen position="center,77" size="900,450" title="File-Explorer">
				<widget name="filedata" position="2,0" size="896,450" itemHeight="25"/>
			        <ePixmap pixmap="skin_default/buttons/red.png" position="60,200" zPosition="0" size="140,40" alphatest="on" />
		                <ePixmap pixmap="skin_default/buttons/green.png" position="250,250" zPosition="0" size="140,40" alphatest="on" />
		                <ePixmap pixmap="skin_default/buttons/yellow.png" position="440,250" zPosition="0" size="140,40" alphatest="on" />
