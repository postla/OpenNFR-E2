...
from Plugins.Extensions.Infopanel.oscamsmartcard import OscamSmartcard
...
######## Softcam Menu ##############################
	def Qsoftcam(self):
		...
		self.sublist.append(QuickSubMenuEntryComponent("OScamSmardCard",_("OScamSmardCard Setup"),_("OScamSmardCard Setup")))
		self.sublist.append(QuickSubMenuEntryComponent("Softcamload",_("Load Softcam.key"),_("Load Softcam.key")))
...
######## Select Softcam Menu ##############################
		...
		elif item[0] == _("OScamSmardCard"):
       			self.session.open(OscamSmartcard)			
		elif item[0] == _("Softcamload"):
                        os.system("/usr/lib/enigma2/python/Plugins/Extensions/Infopanel/data/SatSharing.sh ExecuteOnce")
                        self.session.open(MessageBox, _("Softcam loaded, please check in /usr/keys!"), MessageBox.TYPE_INFO, timeout = 10)
