...
from Plugins.Extensions.Infopanel.plugin import RedPanel

profile("LOAD: OpenNFRGreenPanel")
from Plugins.Extensions.Infopanel.plugin import YellowPanel

class InfoBar(InfoBarBase, InfoBarShowHide,
	InfoBarNumberZap, InfoBarChannelSelection, InfoBarMenu, InfoBarEPG, InfoBarRdsDecoder, RedPanel, YellowPanel,
